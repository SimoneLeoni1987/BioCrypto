...
class Biometrics {
    ...
    companion object {
        ...
        private fun createBiometricPrompt(
                ...
                liveData: MutableLiveData<Result<BiometricPrompt.CryptoObject>>
        ): BiometricPrompt {
            ...
            val callback = object : BiometricPrompt.AuthenticationCallback() {
                override fun onAuthenticationError(errorCode: Int, errString: CharSequence) {
                    ...
                    liveData.postValue(Result.failure(Exception("No crypto")))
                }
                ...
                override fun onAuthenticationSucceeded(result: BiometricPrompt.AuthenticationResult) {
                    ...
                    liveData.postValue(Result.success(result.cryptoObject!!))
                }
            }
        ...
        fun authenticateToEncrypt(cipher: Cipher, fragmentActivity: FragmentActivity): LiveData<Result<BiometricPrompt.CryptoObject>> {
            //readyToEncrypt = true

            val liveData = MutableLiveData<Result<BiometricPrompt.CryptoObject>>()
        ...
        fun authenticateToDecrypt(cipher: Cipher, fragmentActivity: FragmentActivity): LiveData<Result<BiometricPrompt.CryptoObject>> {
